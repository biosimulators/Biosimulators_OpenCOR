...
source_dir = os.path.join(os.path.dirname(__file__), '..', 'biosimulators_opencor')
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))

# -- Project information -----------------------------------------------------
source_base_url = 'https://github.com/biosimulators/Biosimulators_OpenCOR/blob/dev/'
project = 'BioSimulators-OpenCOR'
...
html_theme_options = {
    ...
    'github_repo': 'Biosimulators_OpenCOR',
    'github_banner': True,
    'github_button': True,
    'description': 'BioSimulators-compliant interface to OpenCOR',
    'fixed_sidebar': True,
